...
public class StatisticsVisitor implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
	...
	private int integerExprCounter = 0;
	private int characterExprCounter = 0;
	
	public int getIntegerExprCount() {
		return integerExprCounter;
	}
	
	public int getCharacterExprCount() {
		return characterExprCounter;
	}
	
	public void printStats() {
		System.out.println("Program Statistics");
		System.out.println("Number of Integer Expressions : " + integerExprCounter);
		System.out.println("Number of Character Expressions : " + characterExprCounter);
	}
